...
class BusinessProfileOptionItem {
  const BusinessProfileOptionItem({required this.value, required this.label});

  final String value;
  final String label;
}

class BusinessProfileOptionSelectorSheet extends StatelessWidget {
  const BusinessProfileOptionSelectorSheet({
    super.key,
    required this.items,
    required this.selectedValue,
  });

  final List<BusinessProfileOptionItem> items;
