...
class ClaimDetailDeliverySection extends ConsumerWidget {
  const ClaimDetailDeliverySection({
    super.key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final vm = ref.read(claimDetailViewModelProvider(claimId).notifier);
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              '배송 방법과 출고 옵션을 확인한 뒤 재배송을 진행해 주세요.',
            ...
            Row(
              children: [
                ...List.generate(state.availableDeliveryTabs.length, (index) {
                  ...
                  final isEnabled = _isTabEnabled(tab, deliveryMethods);
                ...
                Column(
                  ...
                  children: [
                    ...
                    _SelectionField(
                      ...
                      onTap: () async {
                        final selected = await WebBottomSheet.show<HanjinBoxType>(
                          context: context,
                          title: '박스크기 선택',
                    ...
                    _SelectionField(
                      ...
                      onTap: () async {
                        final selected = await WebBottomSheet.show<HanjinPayType>(
                          context: context,
                          title: '지불조건 선택',
      ...
      children: [
          ...
          child: Row(
            children: [
              ...
              OutlinedButton(
                ...
                child: Text(
                  '인증',
                  style: context.body.copyWith(color: AppColors.pointColor),
                ),
              ),
            ],
          ),
        ...
        Text(
          validationMessage.isNotEmpty
              ...
              : '송장번호를 인증해주세요.',
          style: context.bodySmall.copyWith(
            color: isValidated ? AppColors.primary : AppColors.darkGrey,
            fontWeight: isValidated ? FontWeight.w700 : FontWeight.w500,
          ),
        ),
      ],
    );
