...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CarrierModel&&(identical(other.code, code) || other.code == code)&&(identical(other.name, name) || other.name == name));
}
...
@override
String toString() {
  return 'CarrierModel(code: $code, name: $name)';
}
...
class _CarrierModel implements CarrierModel {
  const _CarrierModel({this.code = '', this.name = ''});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CarrierModel&&(identical(other.code, code) || other.code == code)&&(identical(other.name, name) || other.name == name));
}
